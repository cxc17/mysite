...
class DealData(object):
    ...
    def site():
        mh = get_mysql()
        sql = "SELECT last_login_site, last_login_ip from `user` where last_login_site != '' and country_cn = '' and last_login_ip " \
